...
<div>
  <img width="40%" src="./xaga-device.png" align="right">
</div>

PixelOS Xaga is the organization for building and publishing PixelOS for Xiaomi `xaga` devices:

- POCO X4 GT
- Redmi K50i
- Redmi Note 11T Pro / Pro+

The current stack in this workspace tracks Android 16 QPR2 / PixelOS 16.2, with a stability-first release focus.
...
* [**MediaTek sepolicy**](https://github.com/pixelos-xaga/android_device_mediatek_sepolicy_vndr) (`android_device_mediatek_sepolicy_vndr`)
...
- [Website](https://pixelos-xaga.vercel.app/)
- [Official PixelOS](https://pixelos.net/)
